  ...
  function D(t, v, o) {
          ...
          v.forEach(function(t, e) {
            ...
            if ((h && (r = y.xNumSteps[e]), r || (r = d - f), !1 !== f && void 0 !== d))
              for (r = Math.max(r, 1e-7), n = f; n <= d; n = (n + r).toFixed(7) / 1) {
                for (
                  u = (a = (o = y.toStepping(n)) - w) / m, p = a / (c = Math.round(u)), i = 1;
                  i <= c;
                  i += 1
                )
            ...
            !(L() && !a.doNotReject) &&
              ...
              !(
                ...
                !(n === f.start && void 0 !== t.buttons && 1 < t.buttons) &&
                  (!a.hover || !t.buttons) &&
                    (d || t.preventDefault(), (t.calcPoint = t.points[v.ort]), void o(t, a)))
          );
          var e, r;
        },
        r = [];
    ...
    function I(t, e) {
      ...
      1 === e.handleNumbers.length &&
        ((r = u[e.handleNumbers[0]].children[0]), (g += 1), ht(r, v.cssClasses.active));
      t.stopPropagation();
      var n = [],
        i = B(f.move, E, Y, {
          target: t.target,
